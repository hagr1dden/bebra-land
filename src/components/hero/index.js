...
export default ({
  ...
  description = "Over the past few decades, we’ve built digital products that create real business value for our clients. Let us help you bring your strategic vision to reality today.",
  imageSrc = `${process.env.PUBLIC_URL}/hero.jpg`,
