...
export default ({
  ...
  imageBorder = false,
  imageShadow = false,
  heading = "Our Colleague About Us.",
  ...
  testimonials = [
    {
      stars: 5,
      profileImageSrc:
        `${process.env.PUBLIC_URL}/ceo.jpeg`,
      heading: "Amazing User Experience",
      quote:
        "Сосем грамотно и хорошо",
      customerName: "Artem Kozel",
      customerTitle: "CEO, BEBRALAND Inc."
    },
    {
      stars: 5,
      profileImageSrc:
        `${process.env.PUBLIC_URL}/cto.jpeg`,
      heading: "Love the Developer Experience and Design Principles !",
      quote:
        "Можем подогнать бутылку",
      customerName: "Evgeny Vasilevsky",
      customerTitle: "CTO, BEBRALAND Inc."
    },
    {
      stars: 5,
      profileImageSrc:
        `${process.env.PUBLIC_URL}/fa.jpeg`,
      heading: "Love the Developer Experience and Design Principles !",
      quote:
        "Могу потрогать вашу волчицу",
      customerName: "Pavel Gembaruk",
      customerTitle: "FA, BEBRALAND Inc."
    }
  ]
}) => {
